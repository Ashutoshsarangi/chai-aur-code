...
const book = {
  ...
  getDefaultInfo: function () {
    console.log("This is default information --> ", this);
  },
  add: function (noOfPage, author, summary, category) {
    this.category = category;
    this.summary = summary;
    this.author = author;
    this.noOfPage = noOfPage;
  },
  printBookDetail: function () {
    console.log(this);
  },
};

book.add(100, "Ashu", "This is a New Book, related to UI", "UI");
